                        ...
                        for i6 in range(-4, 4):
                            for i7 in range(-4, 4):
                                ...
                                if S[7] > maxS7:
                                    maxS7 = S[7]
                                    x7 = x.copy()
print('maxS0 = %10.2f' % maxS0)
for i in range(0, N):
    print('%4.0f' % x0[i], end='')
print()
    
print('maxS1 = %10.2f' % maxS1)
for i in range(0, N):
    print('%4.0f' % x1[i], end='')
print()
    
print('maxS2 = %10.2f' % maxS2)
for i in range(0, N):
    print('%4.0f' % x2[i], end='')
print()
    
print('maxS3 = %10.2f' % maxS3)
for i in range(0, N):
    print('%4.0f' % x3[i], end='')
print()

print('maxS4 = %10.2f' % maxS4)
for i in range(0, N):
    print('%4.0f' % x4[i], end='')
print()
    
print('maxS5 = %10.2f' % maxS5)
for i in range(0, N):
    print('%4.0f' % x5[i], end='')
print()
    
print('maxS6 = %10.2f' % maxS6)
for i in range(0, N):
    print('%4.0f' % x6[i], end='')
print()
    
print('maxS7 = %10.2f' % maxS7)
for i in range(0, N):
    print('%4.0f' % x7[i], end='')
print()
print("Chạy xong!")