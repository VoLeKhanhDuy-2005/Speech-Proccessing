...
record_btn = Button(voice_rec, text="Record", command=lambda m=1:threading_rec(m))
#Stop button
stop_btn = Button(voice_rec, text="Stop", command=lambda m=2:threading_rec(m))
#Play button
play_btn = Button(voice_rec, text="Play", command=lambda m=3:threading_rec(m))

view_detail_btn = Button(voice_rec, text="View")
